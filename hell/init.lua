...
minetest.register_node("hell:hell_tin", {
	description = "Hell Tin Ore",
	tiles = {"nether_rack.png^default_mineral_tin.png"},
	groups = {cracky = 3},
...
if minetest.get_modpath("moreores") ~= nil then
	minetest.register_node("hell:hell_silver", {
		description = "Hell Silver Ore",
	...
	minetest.register_node("hell:hell_mithril", {
		description = "Hell Mithril Ore",
		tiles = {"nether_rack.png^moreores_mineral_mithril.png"},
		groups = {cracky = 3},
		drop = 'moreores:mithril_lump 4',
		light_source = 10,
		paramtype = "light",
		sounds = default.node_sound_stone_defaults(),
		after_dig_node = function(pos, oldnode, oldmetadata, digger)
...
if minetest.get_modpath("technic_worldgen") ~= nil then
	minetest.register_node("hell:hell_uranium", {
		description = "Hell Uranium Ore",
		tiles = {"nether_rack.png^technic_mineral_uranium.png"},
		groups = {cracky = 3},
		drop = 'technic:uranium_lump 4',
		light_source = 10,
		paramtype = "light",
		sounds = default.node_sound_stone_defaults(),
		after_dig_node = function(pos, oldnode, oldmetadata, digger)
	...
	minetest.register_node("hell:hell_chromium", {
		description = "Hell Chromium Ore",
	...
	minetest.register_node("hell:hell_zinc", {
		description = "Hell Zinc Ore",
		tiles = {"nether_rack.png^technic_mineral_zinc.png"},
		groups = {cracky = 3},
	...
	minetest.register_node("hell:hell_lead", {
		description = "Hell Lead Ore",
		tiles = {"nether_rack.png^technic_mineral_lead.png"},
		groups = {cracky = 3},
		drop = 'technic:lead_lump 4',
		light_source = 10,
		paramtype = "light",
		sounds = default.node_sound_stone_defaults(),
		after_dig_node = function(pos, oldnode, oldmetadata, digger)
	...
	minetest.register_node("hell:hell_sulfur", {
		description = "Hell Sulfur Ore",
